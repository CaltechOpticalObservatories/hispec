"""Test cases for the PIControllerBase class in hispec.util.pi.pi_controller module."""
import json
...
@patch("hispec.util.pi.pi_controller.GCSDevice")
def test_list_devices_on_chain(mock_gcs_device_cls):  # pylint: disable=unused-argument
...
@patch("hispec.util.pi.pi_controller.GCSDevice")
def test_disconnect_all(mock_gcs_device_cls): # pylint: disable=unused-argument
...
@patch("hispec.util.pi.pi_controller.GCSDevice")
def test_get_serial_number(mock_gcs_device_cls):  # pylint: disable=unused-argument
